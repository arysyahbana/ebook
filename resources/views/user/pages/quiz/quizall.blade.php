    ...
    <div id="my_modal_2" class="modal">
        <div class="modal-box bg-white text-slate-700">
            ...
            <div class="flex justify-center items-center gap-3">
                <a href="{{ route('quiz.all') }}" class="bg-red-500 text-white px-5 py-2 rounded-lg shadow-md hover:bg-red-600 transition-all duration-300 text-sm">Ulangi</a>
                <a href="{{ route('index') }}" class="bg-sky-500 text-white px-5 py-2 rounded-lg shadow-md hover:bg-sky-600 transition-all duration-300 text-sm">Lanjutkan</a>
            </div>
        </div>
    </div>
