                            ...
                            <x-admin.table id="datatable">
                                ...
                                @endslot
                                    <tr>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="#"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <x-admin.input type="text" placeholder="Judul"
                                        ...
                                        <!-- Modal Hapus Setting -->
                                        <div class="modal fade" id="hapusSetting"
                                            data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                            aria-labelledby="hapusSettingLabel" aria-hidden="true">
